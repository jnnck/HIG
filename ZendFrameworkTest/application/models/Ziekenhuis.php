...
class Application_Model_Ziekenhuis
{
    ...
    public function getZiekenhuis_id() { return $this->_ziekenhuis_id; }
    public function setZiekenhuis_id($ziekenhuis_id) { $this->_ziekenhuis_id = $ziekenhuis_id; }
    ...
    public function getStraat() { return $this->_straat; }
    public function setStraat($straat) { $this->_straat = $straat; }
    
    public function getNaam() { return $this->_naam; }
    public function setNaam($naam) { $this->_naam = $naam; }
    
    public function getNr() { return $this->_nr; }
    public function setNr($nr) { $this->_nr = $nr; }
    ...
    public function setObjectid($objectid) { $this->_objectid = $objectid; }
    
    public function getArea() { return $this->_area; }
    public function setArea($area) { $this->_area = $area; }
            
    public function getLen() { return $this->_len; }
    public function setLen($len) { $this->_len = $len; }
