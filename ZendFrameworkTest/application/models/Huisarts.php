...
class Application_Model_Huisarts
{
    ...
    public function getHuisarts_id() { return $this->_huisarts_id; }
    public function setHuisarts_id($huisarts_id) { $this->_huisarts_id = $huisarts_id; }
    ...
    public function getIdnr09() { return $this->_idnr09; }
    public function setIdnr09($idnr09) { $this->_idnr09 = $idnr09; }
    
    public function getNaam() { return $this->_naam; }
    public function setNaam($naam) { $this->_naam = $naam; }
    
    public function getVoornaam() { return $this->_voornaam; }
    public function setVoornaam($voornaam) { $this->_voornaam = $voornaam; }
    ...
    public function getPraktijk() { return $this->_praktijk; }
    public function setPraktijk($praktijk) { $this->_praktijk = $praktijk; }
    
    public function getGeslacht() { return $this->_geslacht; }
    public function setGeslacht($geslacht) { $this->_geslacht = $geslacht; }
